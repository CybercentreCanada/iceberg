...
public class TestMetadataTableReadableMetrics extends CatalogTestBase {
    ...
    private static final Types.StructType NESTED_STRUCT_TYPE = Types.StructType
            .of(required(3, "leafStructCol", LEAF_STRUCT_TYPE));

    private static final Schema NESTED_SCHEMA = new Schema(required(4, "nestedStructCol", NESTED_STRUCT_TYPE));

    private static final Schema PRIMITIVE_SCHEMA = new Schema(
    ...
    private Table createNestedTable() throws IOException {
        Table table = validationCatalog.createTable(
                TableIdentifier.of(DATABASE, TABLE_NAME),
                NESTED_SCHEMA,
                PartitionSpec.unpartitioned(),
                ImmutableMap.of());
    ...
    public void testNestedValues() throws Exception {
        ...
        long leafDoubleColSize = (long) ((Row) ((Row) result.get(0).getField(0)).getField(0)).getField(0);
